...
@NgModule({
  declarations: [AppComponent, HeaderComponent, CallsComponent, AudioStreamComponent, LoginComponent, FooterComponent, MoreinfoComponent, HistoryComponent, ChatuiComponent,CallDetailsComponent, LandingComponent, IamManagementComponent],  imports: [
    BrowserModule,
    AppRoutingModule,
    GuiGridModule,
    HttpClientModule,
